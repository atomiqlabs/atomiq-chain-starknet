...
export declare const createStarknet: (options: StarknetOptions, bitcoinRpc: BitcoinRpc<any>, network: BitcoinNetwork) => ChainData<StarknetChainType, StarknetAssetsType>;
