...
export declare function toHexSafe(value: number | bigint | string | Buffer | undefined | null, length?: number): string;
...
export declare function toBigIntSafe(value: BigNumberish | Uint256 | undefined): bigint;
export declare function toBigInt(value: BigNumberish | Uint256): bigint;
export declare function toBigInt(value: undefined): null;
export declare function toBigInt(value: BigNumberish | Uint256 | undefined): bigint | null;
...
export declare function assertNotNull<T>(value: T, fieldName: string): asserts value is NonNullable<T>;
export declare function notNull<T>(value: T, message?: string): NonNullable<T>;
