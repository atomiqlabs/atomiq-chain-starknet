...
export class RpcProviderWithRetries extends RpcProvider {
    ...
    constructor(options?: RpcProviderOptions, retryPolicy?: {
        ...
        if(channelId==="RPC090") {
            this.channel = new Rpc09ChannelWithRetries({ ...options, waitMode: false }, retryPolicy) as any;
            ...
            this.channel = new Rpc010ChannelWithRetries({ ...options, waitMode: false }, retryPolicy) as any;
        }
    }
